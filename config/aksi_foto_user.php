...
if(isset($_POST['tambah'])) {
    ...
    if(move_uploaded_file($lokasi_file, $direktori)) {
        $query = "INSERT INTO foto (judulfoto, deskripsifoto, AlbumID, lokasifile, tanggalunggah, userid) VALUES ('$judulfoto', '$deskripsifoto', '$AlbumID', '$nama_file', NOW(), '{$_SESSION['userid']}')";
...
if (isset($_POST['hapus'])) {
    ...
    window.location.href='../user/foto.php'; // Perbaikan tanda kutip pada lokasi redirect
    </script>";
}
?>
